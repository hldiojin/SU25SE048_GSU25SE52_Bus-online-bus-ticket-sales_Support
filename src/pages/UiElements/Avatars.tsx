...
export default function Avatars() {
  return (
    <>
      <PageMeta
        title="React.js Avatars Dashboard | XeTiic - React.js Admin Dashboard Template"
        description="This is React.js Avatars Dashboard page for XeTiic - React.js Tailwind CSS Admin Dashboard Template"
      />
