...
export default function Videos() {
  return (
    <>
      <PageMeta
        title="React.js Videos Tabs | XeTiic - React.js Admin Dashboard Template"
        description="This is React.js Videos page for XeTiic - React.js Tailwind CSS Admin Dashboard Template"
      />
